    ...
    <Form onSubmit={handleSubmit}>
      ...
      <Form.Group>
        ...
        <Form.Control
          ...
          required
        />
        {confirmPasswordError && <p className="mt-1 alert alert-danger" style={{textAlign:'center'}}>{confirmPasswordError}</p>}
      </Form.Group>
      <Button variant="primary" type="submit" className="btn-primary" style={{marginTop:'10px'}}>
        Register
      </Button>
          {message ? <p className="mt-3 alert alert-success" style={{textAlign:'center'}}>{message}</p> : null} 
    </Form>
		</div>
		</div>
		</div>
